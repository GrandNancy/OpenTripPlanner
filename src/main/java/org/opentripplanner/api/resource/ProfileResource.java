...
public class ProfileResource {
    ...
    public Response profileRoute (
            ...
            @QueryParam("triangleSafetyFactor")      @DefaultValue("0.333333") double triangleSafetyFactor,
            @QueryParam("triangleSlopeFactor")      @DefaultValue("0.333333") double triangleSlopeFactor,
            @QueryParam("triangleTimeFactor")      @DefaultValue("0.333333") double triangleTimeFactor,
